...
Protip: the last letter for the first set of red anchors will always be `j` so you can quickly keep going down/up if you need to after `<Leader>j` or `<Leader>k`.
